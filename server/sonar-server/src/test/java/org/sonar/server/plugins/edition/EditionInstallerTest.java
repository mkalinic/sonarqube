...
public class EditionInstallerTest {
  ...
  private EditionInstaller installer = new EditionInstaller(downloader, uninstaller, pluginRepository, executor, updateCenterMatrixFactory);
  ...
  public void launch_task_download_plugins() {
    ...
    verify(downloader).installEdition(Collections.singleton(PLUGIN_KEY), updateCenter);
  }
  ...
  public void check_plugins_to_install_and_remove() {
    ...
    verify(downloader).installEdition(Collections.singleton("p4"), updateCenter);
  ...
  public void do_nothing_if_offline() {
    ...
    installer = new EditionInstaller(downloader, uninstaller, pluginRepository, executor, updateCenterMatrixFactory);
